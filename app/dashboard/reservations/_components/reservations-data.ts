...
export const initialData: Reservation[] = [
  ...
  { id: 'r-007', memberId: 'u-107', memberName: 'Claudine Ingabire', memberEmail: 'claudine@example.com', resourceId: 'res-4', resourceTitle: 'Foundations of Faith', resourceAuthor: 'Dr. Elias Nkubito', resourceType: 'Book', totalCopies: 5, borrowedCopies: 5, queuePosition: 1, reservationDate: daysAgo(6), notifiedAt: daysAgo(1), claimDeadline: hoursFromNow(23), status: 'notified' },
  { id: 'r-008', memberId: 'u-108', memberName: 'David Ndayisenga', memberEmail: 'davidn@example.com', resourceId: 'res-4', resourceTitle: 'Foundations of Faith', resourceAuthor: 'Dr. Elias Nkubito', resourceType: 'Book', totalCopies: 5, borrowedCopies: 5, queuePosition: 2, reservationDate: daysAgo(4), notifiedAt: null, claimDeadline: null, status: 'pending' },
  { id: 'r-009', memberId: 'u-109', memberName: 'Sarah Uwase', memberEmail: 'sarah@example.com', resourceId: 'res-5', resourceTitle: 'Leading with Humility', resourceAuthor: 'Pastor Emmanuel Rugamba', resourceType: 'Book', totalCopies: 2, borrowedCopies: 2, queuePosition: 1, reservationDate: daysAgo(12), notifiedAt: daysAgo(7), claimDeadline: daysAgo(5), status: 'claimed' },
  { id: 'r-010', memberId: 'u-110', memberName: 'Peter Niyonzima', memberEmail: 'peter@example.com', resourceId: 'res-6', resourceTitle: 'The Kingdom Economy', resourceAuthor: 'Dr. Elias Nkubito', resourceType: 'Book', totalCopies: 3, borrowedCopies: 3, queuePosition: 1, reservationDate: daysAgo(15), notifiedAt: daysAgo(10), claimDeadline: daysAgo(8), status: 'expired' },
  { id: 'r-011', memberId: 'u-111', memberName: 'Esther Kabatesi', memberEmail: 'esther@example.com', resourceId: 'res-1', resourceTitle: 'Walking in Covenant', resourceAuthor: 'Pastor Emmanuel Rugamba', resourceType: 'Book', totalCopies: 6, borrowedCopies: 6, queuePosition: 1, reservationDate: daysAgo(2), notifiedAt: null, claimDeadline: null, status: 'pending' },
  { id: 'r-012', memberId: 'u-112', memberName: 'Samuel Byiringiro', memberEmail: 'samuel@example.com', resourceId: 'res-1', resourceTitle: 'Walking in Covenant', resourceAuthor: 'Pastor Emmanuel Rugamba', resourceType: 'Book', totalCopies: 6, borrowedCopies: 6, queuePosition: 2, reservationDate: daysAgo(1), notifiedAt: null, claimDeadline: null, status: 'cancelled' },
]
