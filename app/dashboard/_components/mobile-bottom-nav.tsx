...
import { LayoutDashboard, BookOpen, Users, Shield, Bell } from "lucide-react";
 ...
 * below the `md:` breakpoint. Renders alongside `Sidebar` (which hides itself
 * below `md:`) rather than replacing it — desktop sidebar behavior is untouched.
 */
