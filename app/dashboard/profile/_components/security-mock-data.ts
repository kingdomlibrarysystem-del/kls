...
export const mockSessions: SessionEntry[] = [
  ...
  { id: 'sess-003', device: 'Firefox on macOS',        location: 'Musanze, Rwanda', lastActive: '2026-06-20 14:05', current: false },
]
...
export const mockLoginHistory: LoginEvent[] = [
  ...
  { id: 'log-004', date: '2026-06-20 14:05', ip: '196.44.10.5',    device: 'Firefox on macOS',  success: true },
]
