...
/**
 * Real Stripe webhook receiver for course-order checkouts (the only
 * Order-family model with a real Stripe rail today — plain Order/Cart
 * checkout is PayPack-only, see Order's docstring). Reads the raw
